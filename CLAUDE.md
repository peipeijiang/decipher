...
| AI分析 | 多模型支持（OpenAI / Claude / 豆包2.0 / MiniMax / 智谱 / DeepSeek等） |
| 自动化测试 | Playwright |
...
│   │   ├── ai_models/     # AI模型实现（openai, claude, doubao, minimax, zhipu, deepseek）
...
支持的模型：OpenAI / Claude / 豆包2.0 / MiniMax / 智谱 / DeepSeek / Cohere / Replicate / HuggingFace
